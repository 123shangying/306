...
import com.james.motion.add.bean.UserBean;
import com.james.motion.add.utils.AnalysisUtils;
import com.james.motion.add.utils.DBUtils;
...
public class UserInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if (bean == null) {
            ...
            bean.nickName="306轨迹，记你所记！";
            bean.sex="男";
            bean.signature="306轨迹，记你所记！";
            //保存用户信息到数据库
